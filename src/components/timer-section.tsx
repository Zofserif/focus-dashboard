              ...
              <div className="flex items-center gap-3">
                ...
                >
                  {isBreak
                    ? formatTime(
                        enableBreaks
                          ? (completedCycles % cyclesUntilLongBreak === 0 ? longBreak : shortBreak) * 60
                          : timeLeft,
                      )
                    : formatTime(timeLeft)}
                </div>
                  ...
                  <DropdownMenuContent className="w-80 p-4" align="end">
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 gap-3">
                        ...
                        <div className="space-y-2">
                          <label className="text-sm font-medium">Cycles until Long Break</label>
                          <Input
                            type="number"
                            value={cyclesUntilLongBreak}
                            onChange={(e) => onCyclesUntilLongBreakChange(Number(e.target.value))}
                            min="2"
                            max="10"
                            disabled={!enableBreaks}
                            className="h-8"
